...
import Gradebook from '../components/Gradebook'; // Importamos o diário
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        {!isEditingName ? (
          <div className="flex justify-between items-center">
            ...
            {isUserAdmin && <button onClick={() => setIsEditingName(true)} className="text-sm text-blue-600 font-semibold">Editar</button>}
          </div>
        ) : (
